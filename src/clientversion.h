...
//! These need to be macros, as clientversion.cpp's and kepler*-res.rc's voodoo requires it
...
/**
 * keplerd-res.rc includes this file, but it cannot cope with real c++ code.
