    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KPL-light"), QVariant("light"));
    ui->theme->addItem(QString("KPL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("KPL-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("KPL-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("KPL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KPL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KPL-traditional"), QVariant("trad"));
