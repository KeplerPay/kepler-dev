...
All the Kepler in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KPL, 0.1 KPL, 1 KPL and 10 KPL -- sort of like the paper money you use every day.</li> \
