TOR SUPPORT IN KPL CORE
=======================

It is possible to run Kepler Core as a Tor hidden service, and connect to such services.
...
1. Run Kepler Core behind a Tor proxy
----------------------------------

The first step is running Kepler Core behind a Tor proxy. This will already make all
...
2. Run a Kepler Core hidden server
-------------------------------
...
your dashd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell Kepler Core about its publicly reachable address using
...
3. List of known Kepler Core Tor relays
------------------------------------
...
Kepler Core has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
Kepler Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Kepler Core is listening (`-listen`), and
