...
## Step 0: Install kepler_hash

https://github.com/keplerpay/kepler_hash
...
JSON-RPC server. Running `keplerd` or `kepler-qt -server` will be sufficient.
...
* `input`: keplerd blocks/ directory containing blkNNNNN.dat
